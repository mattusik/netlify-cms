...
description: Netlify CMS 2.1.0 adds external media support with Uploadcare,
  allowing files like images and videos to be stored outside of your Git
  repository.
meta_description: asdadsdsaasddsaads
